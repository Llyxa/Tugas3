            ...
            <div class="card">
                <form action="/updatedata/{{ $data->id }}" method="POST">
                    @csrf
                      ...
                      <input type="text" name="nama" placeholder="Nama hotel" value="{{ $data->nama }}"><br>
                      ...
                      <input type="text" name="harga" placeholder="Harga per malam" value="{{ $data->harga }}">
            
                      <label for="" class="font">Pilih Foto Hotel:</label>
                      <input type="file" name="image" accept="image/png, image/jpeg" value=""><br><br>
                      ...
                      <textarea name="sinopsis" id="" value="{{ $data->sinopsis }}"></textarea>
